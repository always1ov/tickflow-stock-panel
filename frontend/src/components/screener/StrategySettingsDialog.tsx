...
// [同步作者 v0.2.4] 两边各加了自己的 import, 两边的函数在这个文件里**都还在用**:
// fork 的 paramOptionValue/Label 在第 158 行, 作者新加的 toPercentages/
// normalizeWeights 在第 246/295 行。所以两行都留。
...
Object.assign(FIELD_LABEL, {
  ...
  boll_upper: '20日布林上轨', boll_lower: '20日布林下轨',   // [R528] 图表画的是 26 日那组, 这里是 enriched 的 20 日列
  ma20_bias: 'MA20乖离率',
})
