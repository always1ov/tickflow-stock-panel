...
// [R349] 「走势」那一格也抽出去了 —— 模拟盘要用同一份。
// `posWord`/`volWord` 在这里转口导出: `todayHtmlExport` 一直从本模块拿,
// 改它的 import 路径没有好处, 而「分界只有一处定义」已经由新文件保证。
import { TrendCell, posWord, volWord } from '@/components/today/TrendCell'
export { posWord, volWord }
