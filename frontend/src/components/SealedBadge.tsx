    ...
    <>
      <div className="relative inline-flex items-center">
        <button
          ...
          className="group inline-flex items-center gap-1 h-5 px-2 rounded-btn bg-yellow-500/10 border border-yellow-500/30 cursor-help transition-ui hover:bg-yellow-500/20 hover:border-yellow-500/50"
        >
