...
export const SCREENER_BUILTIN_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'builtin:boll_upper', source: { type: 'builtin', key: 'boll_upper' }, label: '布林上轨(20日)', visible: false, align: 'right' },
  { id: 'builtin:boll_lower', source: { type: 'builtin', key: 'boll_lower' }, label: '布林下轨(20日)', visible: false, align: 'right' },
