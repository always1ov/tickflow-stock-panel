...
export const SCREENER_BUILTIN_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'builtin:boll_upper', source: { type: 'builtin', key: 'boll_upper' }, label: '20日布林上轨', visible: false, align: 'right' },
  { id: 'builtin:boll_lower', source: { type: 'builtin', key: 'boll_lower' }, label: '20日布林下轨', visible: false, align: 'right' },
