 ...
 *
 * 原文**没写颜色**的四样(平均线、吸筹那条线、「升」「顶」「下」三个字)用的是通达信
 * 的默认色, 跟各人的配色方案走, 这里先取白 / 浅灰, **等用户发通达信截图再校准**。
 * 默认色里的第三条是洋红 —— 全站禁粉(AGENTS.md 第 15 条), 就算截图上是洋红也换掉。
 */
export const TREND_QUANT_COLORS = {
  ...
  avg: '#FFFFFF',        // 平均线: 原文无色, 待截图校准
  xichou: '#C0C0C0',     // 吸筹那条线: 原文无色, 待截图校准
  text: '#FFFFFF',       // 升 / 顶 / 下: 原文无色, 待截图校准
  paneBg: '#000000',
} as const
