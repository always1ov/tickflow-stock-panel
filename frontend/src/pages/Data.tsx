...
export function Data() {
  ...
  return (
    <>
      ...
      {/* [R326 同步上游] 上游 9602f176「数据页容器水平居中」把这里换成了一层
          `mx-auto px-8 py-6 max-w-6xl`。**不取** —— 它要的居中 fork 内层那个
          `mx-auto w-full max-w-[1100px]` 已经做到了, 换过去反而丢掉两样东西:
          R60 的全站统一留白, 以及这一层里 fork 增强的「数据目录未挂卷」警告。 */}
