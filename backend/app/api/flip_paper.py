...
# [R357] 上限从 10 年收到 3 年。用户: 「也不需要回溯那么多, 没多大意义, 极少我
# 手动去选择的时候看长期」—— 而 R339 那次用户说的原话已经是「**只看近三年**和
# 短周期」, 10 这个数当时就没跟着改, 是个漏网的旧值。
#
# **收上限不是"少给功能"**: 这套模拟盘的标的是**当前自选**, 而自选是一直在变的。
# 拿今天这份名单去跑 2019 年, 算出来的是"假如我五年前就持有今天才选出来的这些
# 票" —— 那条曲线漂亮得毫无意义, 因为它偷看了未来。窗口越长, 这个偏差越大。
# 三年已经在这个偏差能忍的边上。
MAX_YEARS = 3
